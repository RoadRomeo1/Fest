...
<form action="com.hbm.redirecter.RedirecterForOldDataDeletion_Pair" method="get" onsubmit="return myFunction1(this);">
<select name="sel" class="sel" title="Select name of the player for updation.">
<c:forEach items="${requestScope.record }" var="a">
<option value="<c:out value="${a.partner1}"/>"><c:out value="${a.partner1}"/></option>
</c:forEach>
</select>
<br>
<br>
...
function myFunction1(theForm) {
	  var flag;
	  var r = confirm("!Are you sure you want to delete the selected data(once you deleted data never recovers.).");
	  if (r == true) {
	   flag=true;   
	} else {
