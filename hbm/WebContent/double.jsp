...
<div class="content">
<form method="get" action="com.hbm.control.couple">
<table>
<tr>
<td><input type="text" name="partner1" class="txt" placeholder="Member*" title="Member-1" required="required"></td>
<td><input type="text" name="partner2" class="txt" placeholder="Member" title="Member-2" required="required"></td>
</tr>
...
<div class="content">
   <a href="com.hbm.display.disPartner" class="link">Show the data</a>
    </div>
<br>
<br>
<br>
