...
/**
 * Servlet implementation class up_Show
 */
@WebServlet("/com.hbm.display.up_Show")
public class up_Show extends HttpServlet {
	private static final long serialVersionUID = 1L;
       ...
       RequestDispatcher rd=request.getRequestDispatcher("Update_Data");
