...
@WebServlet("/com.hbm.display.up_pair_Show")
public class up_pair_Show extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        while(it.hasNext()) {
        	...
        	System.out.println("Name: "+d.getPartner1());
             record.add(d);			
        }
        
        request.setAttribute("record", record);
        
        RequestDispatcher rd=request.getRequestDispatcher("update_pair");
