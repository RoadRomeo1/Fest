...
@WebServlet("/com.hbm.redirecter.RedirecterForOldDataDeletion")
public class RedirecterForOldDataDeletion extends HttpServlet {
	...
	Transaction t=session.beginTransaction();
	 ...
	 Query q=session.createQuery("delete from HbmData data where name=:name");
	 ...
	 Query q1=session.createQuery("delete from HbmData data where name=:name");
