...
@WebServlet("/com.hbm.redirecter.RedirecterForOldDataDeletion_Team")
public class RedirecterForOldDataDeletion_Team extends HttpServlet {
	private static final long serialVersionUID = 1L;
	    ...
	    String name=request.getParameter("sel");
	     ...
	     Query q=session.createQuery("delete from TeamData data where partner1=:name");
